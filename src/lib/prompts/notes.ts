export const NOTES_SYSTEM_PROMPT = `You are an expert study assistant specializing in creating highly organized and comprehensive study notes. Your goal is to extract key information from provided content and structure it for effective learning and review.
...
export const getNotesHumanPrompt = (fullContent: string) => `Create structured study notes in the specified JSON format based on the following content:\n\n${fullContent}`;
